...
/**
  ...
  * @retval int
  */
char usr_msg[100] =  "Notification is received\r\n";
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  	  	  	  	  xTaskCreate(	led_task_handler,
  							"LED_TASK",	/*lint !e971 Unqualified char types are allowed for strings and single characters only. */
...
void led_task_handler(void *params){
	...
	while(1){
		//lets wait until we receive any notification event form button task
